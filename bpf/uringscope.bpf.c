 ...
 */
/* vmlinux.h is generated by bpftool; on recent kernels it emits a few empty
 * forward declarations (struct ns_tree; etc.) that trip -Wmissing-declarations.
 * Silence that one warning only around the include, not for our own code. */
